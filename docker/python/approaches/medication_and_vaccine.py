...
class medication_and_vaccine(Approach):
    ...
    @classmethod
    def generate_possible_action(cls, outbreak: Event, city: City, vaccine: bool, deployable: list) -> PossibleAction:
    ...
    @classmethod
    def is_action_executable(cls, action: PossibleAction, state: GameState):
        if action.is_vaccine:
    ...
    @classmethod
    def get_not_vaccinated_outbreaks_for_city(cls, city: City):
        events = city.events
    ...
    @classmethod
    def get_not_medicated_outbreaks_for_city(cls, city: City):
        events = city.events
